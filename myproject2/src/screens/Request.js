...
const Request =({navigation}) =>{
    ...
    imageStyle= {{opacity:0.5}}>
            ...
            <View 
            //style={{
                //backgroundColor:'#E8CCE8',
                //backgroundColor:'#afeeee',
                //borderColor:'#48d1cc', 
                //borderBottomWidth:2,
                //borderBottomRightRadius:40,
               //</ImageBackground>/ borderBottomLeftRadius:40}}
               >
        ...
        <TouchableOpacity onPress={navigation.goBack}
             style={{width:50,height:50,padding:10,marginLeft:10, marginTop:10 }}>
              <Image source={require('../assets/backarrow.png')} 
               style={{width:'70%',height:'70%',}}/>
        </TouchableOpacity>

            <Text style={{textAlign:"center",fontWeight:"bold", marginLeft:10, fontSize:17, marginTop:10}} >Your Requests</Text>
        </View>
...
{/**View 2 */}
        ...
        <View style={{
              ...
              borderBottomWidth:2,
                ...
                <TouchableOpacity>
                <Text style={{textAlign:"center", fontSize:15,  color:'#1e90ff', marginRight:20}}>1 View</Text>
                </TouchableOpacity>
                </View>
{/*profile*/}
